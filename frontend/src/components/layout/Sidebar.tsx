            ...
            <aside className={cn(
                ...
                <div className="flex items-center justify-between p-4 h-16 border-b">
                    {(sidebarOpen || (window.innerWidth >= 1024)) && (
                        <span className={cn("text-xl font-bold text-black", !sidebarOpen && "lg:hidden")}>Fishifox</span>
                    )}
                    <button
                ...
                <div className="absolute bottom-4 left-0 w-full p-2 text-primary-foreground">
                    <button
                        onClick={logout}
                        className={cn(
