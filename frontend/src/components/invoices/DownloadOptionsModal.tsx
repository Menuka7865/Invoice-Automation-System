                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 gap-3">
                        ...
                        >
                            ...
                            <span className="text-xs text-muted-foreground">Standard "INVOICE" title with Company Logo</span>
                        </button>
                        ...
                        >
                            ...
                            <span className="text-xs text-muted-foreground">Use a custom text title (e.g. "TAX INVOICE")</span>
                        </button>
